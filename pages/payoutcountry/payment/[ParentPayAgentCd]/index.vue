        ...
        <slot>
          <div class="grid grid-cols-3 gap-4 mb-6">
            ...
            <div>
              ...
              class="bg-white input-primary mt-1 focus:border-gray-400 focus:ring-0" v-model="fields.CountryName"
              :class="{
              ...
              <div v-else-if="item.key === 'fieldMapSection'" class="space-y-3">
                <div class="overflow-x-auto">
                  <table class="w-full table-auto border-collapse border border-gray-300">
                    ...
                    <FieldMapping
                      v-for="(value, innerIndex) in fields.FieldMappingConfigs || fields.PayoutFieldMappings"
